		...
		if ( $title )
			...
			<li class="post-list_li clearfix">
				...
				<?php if(has_post_thumbnail()) {
					...
					$image   = aq_resize( $img_url, 370, 141, true ); //resize & crop img
				?>
				...
				<time datetime="<?php the_time('Y-m-d\TH:i'); ?>"><?php the_time('F j, Y'); ?> <i>|</i> <?php the_time('h:i a'); ?> <i>|</i> <?php comments_popup_link(theme_locals("no_comments"), theme_locals("comment"), "% ".theme_locals("comments"), theme_locals("comments_link"), theme_locals("comments_closed")); ?></time>
